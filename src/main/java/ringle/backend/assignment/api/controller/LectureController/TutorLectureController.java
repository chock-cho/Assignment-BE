...
public class TutorLectureController {
    ...
    @PostMapping("/lecture")
    @Operation(summary = "STEP 1️⃣ - 수업 가능한 시간대 생성 API",
            operationId = "1_createLecture", // 숫자 접두사로 순서를 지정
            description = """
                    ...
                    **[Test 예시]**
                    ...
                    - startTimeSlot: SLOT_10_00\s
                    - endTimeSlot: SLOT_11_30\s
                    ```
                    \s""")
    ...
    @Operation(summary = "STEP 2️⃣- 수업 가능한 시간대 삭제 API",
            description = """
